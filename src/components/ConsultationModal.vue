        ...
        >
          ...
          >
            ...
            <div class="relative z-0 pl-8">
              <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/15 border border-white/20 text-xs font-bold text-white/90 mb-2.5">
                <span class="w-2 h-2 rounded-full bg-medical-accent-light animate-pulse"></span>
                <span>جلسة استكشافية مجانية</span>
              </div>
          ...
          <div class="p-6 sm:p-8 max-h-[calc(88vh-120px)] overflow-y-auto">
            ...
            <div v-if="isSuccess" class="py-8 text-center flex flex-col items-center">
              <div class="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-emerald-50 text-emerald-600 flex items-center justify-center mb-5 ring-8 ring-emerald-50/50 shadow-inner">
              ...
              <p class="text-sm sm:text-base text-gray-600 max-w-sm mx-auto leading-relaxed mb-6">
                شكراً لثقتكم بنا. سيقوم فريق المستشارين بمراجعة طلبكم والتواصل معكم عبر الواتساب أو الهاتف لتحديد الموعد المناسب.
              </p>

              <div class="w-full bg-medical-sky-light border border-medical-sky rounded-2xl p-4 mb-6 text-right text-xs sm:text-sm space-y-1.5 text-medical-navy-deep font-semibold">
            ...
            <form v-else @submit.prevent="handleSubmit" class="space-y-4">
              ...
              <div>
                ...
                <div class="relative group">
                  <div class="absolute inset-y-0 right-3.5 flex items-center pointer-events-none text-medical-navy/40 group-focus-within:text-medical-blue transition-colors">
              ...
              <div>
                ...
                <div class="relative group">
                  ...
                  <input
                    ...
                    type="text"
                    placeholder="مثال: جمعية تمكين الأهلية"
                    class="w-full h-12 pr-11 pl-4 bg-medical-sky-light/80 border border-medical-sky rounded-xl text-sm font-semibold text-medical-navy-deep placeholder:text-medical-navy/35 focus:outline-none focus:border-medical-blue focus:bg-white focus:ring-2 focus:ring-medical-blue/15 transition-all text-right"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  class="w-full p-3.5 bg-medical-sky-light/80 border border-medical-sky rounded-xl text-sm font-semibold text-medical-navy-deep placeholder:text-medical-navy/35 focus:outline-none focus:border-medical-blue focus:bg-white focus:ring-2 focus:ring-medical-blue/15 transition-all text-right resize-none"
                ></textarea>
              </div>

              <!-- Error Message Banner -->
              <p v-if="errorMessage" class="p-3 rounded-xl bg-rose-50 border border-rose-200 text-rose-600 text-xs sm:text-sm font-bold text-center">
                {{ errorMessage }}
              </p>
              ...
              >
                <span class="relative z-10 flex items-center justify-center gap-2.5 py-3.5">
                  ...
                  <template v-else>
                    ...
                    <svg class="w-4 h-4 rotate-180 group-hover:-translate-x-1 transition-transform duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div class="flex items-center justify-center gap-1.5 pt-2 text-medical-navy/60 text-[11px] sm:text-xs font-medium">
